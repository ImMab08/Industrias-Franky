...
export default function Client() {
  return (
    <div className='w-max-screen h-[600px] flex justify-center custom-shape-divider-top-1698864150 bg-[#fff]'>
      ...
      <div className='my-auto mx-24'>
        <h1 className=' font-extrabold text-5xl text-center mb-[15px]'>Trabajamos para</h1>
