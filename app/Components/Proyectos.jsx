  ...
  return (
    <div className='my-20'>
      ...
      <div className=' flex items-center flex-col md:flex-row md:justify-between'>
        <div className='transform transition-transform duration-300 ease-in-out hover:scale-110 mt-20 md:ml-20'>
          <img className=' w-[300px] md:w-auto ' src="img/smartmockups_lofyadms-removebg-preview.png" alt="" /> 
          <h1 className='text-terciary font-bold md:text-2xl relative left-[160px] md:left-[250px] bottom-0'>TIENDAS ONLINE</h1>
        </div>
        <div className='transform transition-transform duration-300 ease-in-out hover:scale-110 mt-20 md:mr-20'>
